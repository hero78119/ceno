...
use crate::{
    ...
    tables::{
        ...
        U5TableCircuit, U8TableCircuit, U14TableCircuit, U16TableCircuit, U17TableCircuit,
        XorTableCircuit,
    },
};
use ceno_emul::{
...
pub struct Rv32imConfig<E: ExtensionField> {
    ...
    // Tables.
    pub u17_range_config: <U17TableCircuit<E> as TableCircuit<E>>::TableConfig,
...
impl<E: ExtensionField> Rv32imConfig<E> {
    pub fn construct_circuits(cs: &mut ZKVMConstraintSystem<E>) -> Self {
        ...
        // tables
        let u17_range_config = cs.register_table_circuit::<U17TableCircuit<E>>();
    ...
    pub fn generate_fixed_traces(
        ...
        fixed.register_table_circuit::<U17TableCircuit<E>>(cs, &self.u17_range_config, &());
    ...
    pub fn assign_table_circuit(
        ...
        witness.assign_table_circuit::<U17TableCircuit<E>>(cs, &self.u17_range_config, &())?;
